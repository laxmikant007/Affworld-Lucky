...
function Labourform() {
    ...
    return (
        <>
            {/* <Header /> */}
            <h1 style={{color: "white"}} id="lform">Manager Registration</h1>
                    ...
                    <div className="display2">
                        <div className="display1">
                            ...
                            <label htmlFor="profilePic">Profile Photo:&nbsp;&nbsp;
                                <span style={{ border: "1px solid gray", padding: "10px", background: "#394256", fontSize: "15px", borderRadius: "10px", fontWeight: 500, cursor: "pointer" }} >
                        ...
                        <div className="display1">
                            <label htmlFor="aadharPic">Affiliate ID:&nbsp;&nbsp;
                    ...
                    <div className="display2">
                        <div className="display1">
                            <label htmlFor="aadharPic">Aadhar Photo:
                                ...
                                <span style={{ border: "1px solid gray", padding: "10px", background: "#394256", fontSize: "15px", fontWeight: 500, borderRadius: "10px", cursor: "pointer" }} >
